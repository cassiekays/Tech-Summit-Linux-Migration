...
sudo git clone https://github.com/cassiekays/Tech-Summit-Linux-Migration.git
...
sudo cp Tech-Summit-Linux-Migration/resources/deployment/onprem/database/northwind.sql /var/lib/pgsql
